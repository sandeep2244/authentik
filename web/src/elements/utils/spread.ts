/**
 * Taken from the "@open-wc/lit-helpers" development branch
 * because it's not available via NPM.
 * See: https://github.com/open-wc/open-wc/blob/master/packages/lit-helpers
 */
