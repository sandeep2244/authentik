        ...
        return html`<form class="pf-v5-c-form pf-m-horizontal">
            ...
            <ak-form-element-horizontal name="checkStaticRules">
                <label class="pf-v5-c-switch">
                    ...
                    <span class="pf-v5-c-switch__label">${msg("Check static rules")}</span>
                </label>
            </ak-form-element-horizontal>
            <ak-form-element-horizontal name="checkHaveIBeenPwned">
                <label class="pf-v5-c-switch">
                    ...
                    <span class="pf-v5-c-switch__label">${msg("Check haveibeenpwned.com")}</span>
                </label>
                <p class="pf-v5-c-form__helper-text">
            ...
            <ak-form-element-horizontal name="checkZxcvbn">
                <label class="pf-v5-c-switch">
                    ...
                    <span class="pf-v5-c-switch__label">${msg("Check zxcvbn")}</span>
                </label>
                <p class="pf-v5-c-form__helper-text">
